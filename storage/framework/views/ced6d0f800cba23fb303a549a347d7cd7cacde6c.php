<?php $__env->startSection('content'); ?>
    <div class="container-scroller">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-description"><a class="text-light btn btn-info" href="<?php echo e(route('backoffice.add-store')); ?>">Add New Store</a></div>
                ...
                <table id="example" class="table table-striped display">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>No Active</td>
                      <?php endif; ?>
                      <td><a class="btn btn-warning" class="text-light" href="<?php echo e(route('backoffice.edit-store',$all_Store_data->store_id)); ?>">Edit</a></td>
                    </tr>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/mpos/resources/views/store/allStore.blade.php ENDPATH**/ ?>