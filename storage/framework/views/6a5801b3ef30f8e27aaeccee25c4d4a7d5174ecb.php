                    ...
                    <div class="col-md-10 offset-md-1" style="margin-top: 45px; ">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <form action="<?php echo e(route('backoffice.store-service-return')); ?>" method="post">
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger"><?php $__errorArgs = ['job_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?> <?php unset($message);
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger"><?php $__errorArgs = ['consumer_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger"><?php $__errorArgs = ['consumer_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger"><?php $__errorArgs = ['model_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger"><?php $__errorArgs = ['warranty_card_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?> <?php unset($message);
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger"><?php $__errorArgs = ['purchase_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger"><?php $__errorArgs = ['sending_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger"><?php $__errorArgs = ['est_delivary_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                ...
                                <div class="form-group">
                                    <a class="btn btn-primary mt-2" class="text-light" href="<?php echo e(route('backoffice.all-return')); ?>">Back</a>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/mpos/resources/views/dashboard/return/createServiceReturn.blade.php ENDPATH**/ ?>