                    ...
                    <div class="col-md-6 offset-md-2" style="margin-top: 45px; ">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <form action="<?php echo e(route('backoffice.update-agency')); ?>" method="post">
                                ...
                                <?php $__currentLoopData = $DeliveryAgency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Agency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <input name="id" value="<?php echo e($Agency->delivery_agency_id); ?>" type="hidden">
                                  <div class="form-group">
                                      <label for="delivery_agency_name">Agency Name</label>
                                      <input type="text" class="form-control my-2" name="delivery_agency_name" placeholder="Enter Delivary Agency Name" value="<?php echo e($Agency->delivery_agency_name); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                 ...
                                 <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="delivery_agency_address" placeholder="Enter Delivary Agency Address" value="<?php echo e($Agency->agency_address); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="delivery_agency_contact" placeholder="Enter Delivary Agency Contact" value="<?php echo e($Agency->agency_contact_no); ?>">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlioxoq/public_html/backofficel/resources/views/dashboard/delivery/editAgency.blade.php ENDPATH**/ ?>