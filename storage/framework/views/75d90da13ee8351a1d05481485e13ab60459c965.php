                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $.each(data, function(col, subcat) {
                            var catImage = subcat.sc_one_image;
                            var subcat_html =
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/rpos/resources/views/sales/salesForm.blade.php ENDPATH**/ ?>