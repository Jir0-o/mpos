    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#get-sales-subcategory', function(e) {
                ...
                $('#sales-cat-wise-items').empty();
                $.ajax({
                    url: "purchase-cat-wise-items/" + category_id,
                    type: "GET",
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>"
                    },
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ussbd\POSSIE\resources\views/purchase/purchaseForm.blade.php ENDPATH**/ ?>