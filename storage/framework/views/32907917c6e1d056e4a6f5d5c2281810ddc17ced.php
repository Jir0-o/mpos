                    ...
                    <div class="col-md-6 offset-md-2" style="margin-top: 45px; ">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <form action="<?php echo e(route('backoffice.create-charge')); ?>" method="post">
                                ...
                                <?php echo csrf_field(); ?>
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="deliver_charge_name" placeholder="Enter Delivary Charge Name" value="<?php echo e(old('deliver_charge_name')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <textarea  type="text" class="form-control my-2" name="package_description" 
                                                  placeholder="Enter Package Description" value="<?php echo e(old('package_description')); ?>" rows="4" cols="50"></textarea>
...
unset($__errorArgs, $__bag); ?></span>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="source" placeholder="Enter Source" value="<?php echo e(old('source')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="expected_delivery_days" placeholder="Enter Expected Delivery Days" value="<?php echo e(old('expected_delivery_days')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="delivery_charge" placeholder="Enter Delivery Charge " value="<?php echo e(old('delivery_charge')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <textarea  type="text" class="form-control my-2" name="destination" 
                                                  placeholder="Enter Description" value="<?php echo e(old('destination')); ?>" rows="4" cols="50"></textarea>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlioxoq/public_html/backofficel/resources/views/dashboard/charge/addCharge.blade.php ENDPATH**/ ?>