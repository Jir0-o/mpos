                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $Product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a target="_blank" href="<?php echo e($values->image_path); ?>">
                                                                <img height="100px" width="100px"
                                                                    src="<?php echo e($values->image_path); ?>">
                                                            </a>
                                                        ...
                                                        <td><a class="btn btn-warning" class="text-light"
                                                                href="<?php echo e(route('backoffice.edit-product', Crypt::encryptString($values->product_id))); ?>">Edit</a>
                                                        </td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/thechef/resources/views/dashboard/product/allProduct.blade.php ENDPATH**/ ?>