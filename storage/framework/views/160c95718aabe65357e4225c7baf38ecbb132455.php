                        ...
                        <tbody>
                            <?php $__currentLoopData = $allConsumerData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                ...
                                <td>
                                    <a class="btn btn-dark" href="<?php echo e(route('backoffice.view-consumer',Crypt::encryptString($user->consumer_id))); ?>">
                                         Orders
                                    </a>
                                </td>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="<?php echo e(route('backoffice.view-consumer',Crypt::encryptString($user->consumer_id))); ?>">
                                ...
                                <td>
                                    <a class="btn btn-primary" href="<?php echo e(route('backoffice.edit-backoffice-user',Crypt::encryptString($user->login_id))); ?>">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlioxoq/public_html/backofficel/resources/views/dashboard/backoffice/allConsumer.blade.php ENDPATH**/ ?>