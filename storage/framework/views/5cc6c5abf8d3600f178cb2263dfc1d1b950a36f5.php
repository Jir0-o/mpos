          ...
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              ...
              <div class="d-flex">
                ...
                <button type="button" class="btn btn-sm ml-3 btn-success"><a class="text-dark" href="<?php echo e(route('backoffice.register')); ?>">Add User</a></button>
              </div>
            </div>
            <div class="row">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlioxoq/public_html/backofficel/resources/views/dashboard/backoffice/home.blade.php ENDPATH**/ ?>