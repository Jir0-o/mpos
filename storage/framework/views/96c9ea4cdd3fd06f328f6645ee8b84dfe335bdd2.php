    ...
    <div class="container-scroller">
        ...
        $(document).ready(function() {
            ...
            $("#add_new_bank").on("click",function(){
                ...
                add_bank_body_html+='<form action="<?php echo e(route("insert-bank")); ?>" method="post" enctype="multipart/form-data">'
            ...
            window.GetBanksDataHelper = function() {
                ...
                success: function(data) {
                        $.each(data, function(col, bank) {
                            var url = '<?php echo e(route("edit-bank", ":id")); ?>';
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ussbd\POSSIE\resources\views/bank/bankActions.blade.php ENDPATH**/ ?>