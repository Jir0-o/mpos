                ...
                <div class="row">
                    <div class="col-12 card">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <div class="row">
                                    <div class="col-6 col-md-3">Consumer Name</div>
        ...
        $(document).ready(function() {
            ...
            $('#authorize_status_def').on('change', function() {
                ...
                if(authorize_status==2){
                    ...
                    console.log(authorize_status);
                    var html=`<a href="<?php echo e(route('backoffice.return-authorization',[Crypt::encryptString($return->cart_item_return_id),2])); ?>" class="btn btn-primary">`
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlioxoq/public_html/backofficel/resources/views/dashboard/return/viewReturn.blade.php ENDPATH**/ ?>