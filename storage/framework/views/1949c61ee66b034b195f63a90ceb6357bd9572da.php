    ...
    <div class="container-scroller">
        ...
        <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo e(route('backoffice.insert-expense-category')); ?>" method="post" enctype="multipart/form-data">
                ...
                <?php echo csrf_field(); ?>
                  ...
                  <div class="form-group">
                      ...
                      <a class="btn btn-primary mt-2 float-right" class="text-light" href="<?php echo e(route('backoffice.expense_category_list')); ?>">Back</a>
                  </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/mpos/resources/views/Expense Category/addExpenseCategory.blade.php ENDPATH**/ ?>