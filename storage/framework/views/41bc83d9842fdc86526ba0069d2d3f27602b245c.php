                        ...
                        <div class="col-md-12" style="margin-top: 10px;">
                            <div class="card">
                                ...
                                <div class="card-body" style="overflow-x:scroll;">
                                    ...
                                    <form action="<?php echo e(route('backoffice.store-sales')); ?>" method="post"
                                            ...
                                            <div class="col-md-5">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <hr>
                                                                <div class="row mt-3">
                                                                    <div class="col-3">Table No</div>
                                                                    <div class="col-9">
                                                                        <input class="form-control" name="table_no"
                                                                            type="text" list="suggesstion-box"
                                                                            id="table_no" placeholder="Table No"
                                                                            required />
                                                                    </div>
                                                                </div>
                                                                <div class="row mt-3">
                                                                    <div class="col-3">Select Waiter</div>
                                                                    <div class="col-9">
                                                                        <select class="form-control" name="waiter_id"
                                                                            type="text" list="suggesstion-box"
                                                                            id="waiter_id" placeholder="Waiter Name"
                                                                            required>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="row mt-5">
                                                            <div class="col-6"><a
                                                                    href="<?php echo e(route('backoffice.delete_sales_form')); ?>"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            window.ItemDataHelper = function(data) {
                ...
                if (data.status == true) {
                    ...
                    $.each(data.cart_temporary_data, function(col, temp_cart_item) {
                        ...
                        temp_cart_items_html += "<td>" + i++ +
                            "<input id='temp_cart_id' name='temp_cart_id' type='hidden' value='" +
                            temp_cart_item
                            .temp_cart_id + "'/></td>"
                        temp_cart_items_html += "<td>"
                        temp_cart_items_html += temp_cart_item.product_id
                        temp_cart_items_html += "</td>"
                        temp_cart_items_html += "<td><a id='sales_sales_price'>" + temp_cart_item
                            .sales_price + "</a></td>"
                        temp_cart_items_html += "<td>"
                        ...
                        temp_cart_items_html += "</td>"
                        temp_cart_items_html += "<td><a id='sales_quantity" + i + "' value='" +
                    ...
                    success: function(data) {
                        $.each(data, function(col, categoryWiseItem) {
                            var catWiseImage = categoryWiseItem.product_image.split(
                                ",");
                            var product_html =
                                '<div class="col-3 col-lg-3 col-md-3 mb-1 text-truncate">'
                            product_html += '<a value="' + categoryWiseItem
                                .product_id +
                                '" id="sales-product-item" class="btn" title="' +
                                categoryWiseItem
                                .product_name +
                                '">'
                            // product_html +=
                            //     '<img height="70px" width="75px" src="<?php echo e(asset('backend/images/product/')); ?>' +
                            //     '/' + catWiseImage[0] + '" alt="test">'
                            product_html += '<div>'
                            product_html += '<div>' +
                                categoryWiseItem.product_name +
                                '</div>'
            ...
            $(document).on('click', '#add_suspense', function(e) {
                ...
                $.ajax({
                    url: "add_suspense/" + temp_cart_id + '/' + waiter_id + '/' + table_no,
                    type: "GET",
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>"
                    },
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/thechef/resources/views/sales/salesForm.blade.php ENDPATH**/ ?>