...
unset($__errorArgs, $__bag); ?></span>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
                        ...
                        $.each(data, function(col, categoryWiseItem) {
                            ...
                            product_html+='<td class="p-2">'
                                ...
                                product_html+='<div class="modal fade" id="modal-'+i+'" tabindex="-1" role="dialog" aria-labelledby="modal-'+i+'Title" aria-hidden="true">'
                                    product_html+='<div class="modal-dialog modal-xl" role="document">'
                                        product_html+='<div class="modal-content">'
                                            product_html+='<div class="modal-header bg-primary">'
                                                product_html+='<h4 class="modal-title text-light" id="exampleModalLongTitle">'+categoryWiseItem.product_name+'</h4>'
                                ...
                                product_html+='<div class="card p-3">'
                                    product_html+='<div class="row mb-3">'
                                        product_html+='<div class="col-md-3"><p class="mb-2">Purchase Price</p>'
                                            product_html+='<input name="purchase_price" id="purchase_price-'+i+'" type="text" class="form-control" placeholder="Purchase Price">'
                                        product_html+='</div>'
                                        product_html+='<div class="col-md-3"><p class="mb-2">WholeSale Price</p>'
                                            product_html+='<input name="wholesale_price" id="wholesale_price-'+i+'" type="text" class="form-control" placeholder="WholeSale Price">'
                                        product_html+='</div>'
                                        product_html+='<div class="col-md-3"><p class="mb-2">Sales Price</p>'
                                            product_html+='<input name="sales_price" id="sales_price-'+i+'" type="text" class="form-control" placeholder="Sales Price">'
                                        product_html+='</div>'
                                        product_html+='<div class="col-md-3"><p class="mb-2">Quantity</p>'
                                            product_html+='<input name="quantity" id="quantity-'+i+'" type="text" class="form-control" placeholder="Quantity">'
                                        product_html+='</div>'
                                    product_html+='</div>'
                                product_html+='</div>'
                                product_html+='<div class="card p-3 mt-2">'
                                    product_html+='<div class="row">'
                                        product_html+='<div class="col-md-3"><p class="mb-2">Color</p>'
                                            product_html+='<input name="color" id="color-'+i+'" type="text" class="form-control" placeholder="Color">'
                                        product_html+='</div>'
                                        product_html+='<div class="col-md-3"><p class="mb-2">RAM</p>'
                                            product_html+='<input name="ram" id="ram-'+i+'" type="text" class="form-control" placeholder="RAM">'
                                        product_html+='</div>'
                                        product_html+='<div class="col-md-3"><p class="mb-2">ROM</p>'
                                            product_html+='<input name="rom" id="rom-'+i+'" type="text" class="form-control" placeholder="ROM">'
                                        product_html+='</div>'
                                        product_html+='<div class="col-md-3"><p class="mb-2">Camera</p>'
                                            product_html+='<input name="camera" id="camera-'+i+'" type="text" class="form-control" placeholder="Camera">'
                                        product_html+='</div>'
                                    product_html+='</div>'
                                product_html+='</div>'
                                product_html+='<div class="card p-3 mt-2">'
                                    product_html+='<div class="row justify-content-center">'
                                        product_html+='<div class="col-md-6"><input type="text" id="imei_barcode-'+i+'" class="form-control" placeholder="Click To Scan or Add IMEI/Barcode"/>'
                                        product_html+='</div>'
                                        product_html+='<div class="col-md-6"><div modal_id="'+i+'" id="add_imei_barcode" class="mb-2 text-center btn btn-outline-warning">Click to Add IMEI<i class="fa fa-plus pl-3"></i></div>'
                                        product_html+='</div>'
                                    product_html+='</div>'
                                product_html+='</div>'
                                product_html+='<div class="card p-3 mt-2">'
                                    product_html+='<div class="row">'
                                        product_html+='<div class="col-md-8">'
                                            product_html+='<table class="table">'
                                                product_html+='<thead>'
                                                    product_html+='<tr>'
                                                    product_html+='<th>IMEI No</th>'
                                                    product_html+='<th class="text-right">Action</th>'
                                                    product_html+='</tr>'
                                                    product_html+='</thead>'
                                                    product_html+='<tbody id="new_barcode-'+i+'"></tbody>'
                                            product_html+='</table>'
                                        product_html+='</div>'
                                    product_html+='</div>'
                                product_html+='</div>'
                                product_html+='<div class="modal-footer"><button purchase_details_id="" modal_id="'+i+'" id="submit_modal" data-dismiss="modal" type="button" class="btn btn-primary">Save changes</button></div>'

                        product_html+='</div></div></td>'
            ...
            // Add IMEI with Scanning
            $(document).on('click', '#add_imei_barcode', function(e) {
                e.preventDefault();
                var modal_id = $(this).attr("modal_id");
                var imei_barcode = $("#imei_barcode-"+modal_id).val();
                ...
                var camera = $("#camera-"+modal_id).val();
                var rom = $("#rom-"+modal_id).val();
                var ram = $("#ram-"+modal_id).val();
                var color = $("#color-"+modal_id).val();
                ...
                $("#imei_barcode-"+modal_id).val("").focus();
                ...
                $.ajax({
                    ...
                    async:false,
                    success: function(data) {
                        if(data.quantity_error == true){
                             swal("error",data.message,'error');
                            return ;
                        }
                        $('#new_barcode-'+modal_id).empty();
                        
                        
                        var imeihtml = "";
                        $.each(data, function(key, value) {
                            imeihtml+='<tr><td>'+value.imei+'</td><td class="text-right"><div key="'+value.imei_id+'" modal_id="'+modal_id+'" value="'+value.imei+'" id="delete_imei" class="btn"><i class="fa fa-trash"></i></div></td></tr>'
                        });
                        $('#new_barcode-'+modal_id).append(imeihtml);
                    }
                });
            });

            // Add IMEI with Scanning
            $(document).on('click', '#delete_imei', function(e) {
                var imeiRm = $(this).attr("value");
            ...
            $(document).on('click', '#submit_modal', function(e) {
                ...
                if(!wholesale_price){
                    swal("Please set Wholesale Price",'error','error');
                    return;
                }
                if(!sales_price){
                    swal("Please set Sales Price",'error','error');
                    return;
                }
                if(!quantity){
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/mpos/resources/views/purchase/purchaseFormForMpos.blade.php ENDPATH**/ ?>