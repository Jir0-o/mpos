                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control my-2" name="cost_price"
                                                            placeholder="Enter Cost Price"
                                                            value="<?php echo e($Product->cost_price); ?>" required="required">
                                                        <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-12 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control my-2" name="sales_price"
                                                            placeholder="Enter Sales Price"
                                                            value="<?php echo e($Product->sales_price); ?>" required="required">
                                                        <span class="text-danger">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control my-2" name="bulk_price"
                                                            placeholder="Enter Cost Price"
                                                            value="<?php echo e($Product->bulk_price); ?>" required="required">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-12 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control my-2"
                                                            ...
                                                            value="<?php echo e($final_quantity->final_quantity); ?>"
                                                            required="required">
                                                        <span class="text-danger">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control my-2" name="vat"
                                                            placeholder="Enter Vat Amount" value="<?php echo e($Product->vat); ?>"
                                                            required="required">
                                                        <span class="text-danger">
                                                            <?php $__errorArgs = ['vat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/kaynat/resources/views/dashboard/product/editProduct.blade.php ENDPATH**/ ?>