...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('backend/images/yos_logo.png')); ?>" type="image/x-icon">
                    ...
                    success: function(response) {
                        ...
                        if (len > 0) {
                            ...
                            for (var i = 0; i < len; i++) {
                                ...
                                var delivery_agent_name = response['data'][i]
                                    .delivery_agent_name;

                                var option = "<option value='" + delivery_agent_id + "'>" +
                                    delivery_agent_name + "</option>";
...
<?php /**PATH /home/nescggna/public_html/thechef/resources/views/layouts/layout.blade.php ENDPATH**/ ?>