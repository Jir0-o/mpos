                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-description btn btn-info"><a class="text-light"
                                            href="<?php echo e(route('backoffice.subCat1')); ?>">Add Sub Category One</a></div>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $SubCategoryOne; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a target="_blank" href="<?php echo e($values->sc_one_image_path); ?>">
                                                                <img height="100px" width="100px"
                                                                    src="<?php echo e($values->sc_one_image_path); ?>">
                                                            </a>
                                                        ...
                                                        <td><a class="btn btn-warning" class="text-light"
                                                                href="<?php echo e(route('backoffice.edit-subCat1', Crypt::encryptString($values->sc_one_id))); ?>">Edit</a>
                                                        </td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/thechef/resources/views/dashboard/product/allSubCat1.blade.php ENDPATH**/ ?>