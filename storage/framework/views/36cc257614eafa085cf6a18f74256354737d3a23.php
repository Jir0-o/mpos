                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $Product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo e($values->bulk_price); ?>

                                                        </td>
                                                        <td>
                                                            <?php if($values->barcode == null): ?>
                                                                <a class="btn" class="text-light"
                                                                    href="<?php echo e(route('backoffice.create-barcode', Crypt::encryptString($values->product_id))); ?>"><i
                                                                        class="fa fa-barcode"></i></a>
                                                            <?php else: ?>
                                                                <a target="_blank" class="brn"
                                                                    href="<?php echo e(route('backoffice.print-barcode', Crypt::encryptString($values->product_id))); ?>"><img
                                                        ...
                                                        <td>
                                                            <?php echo e($values->final_quantity); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/kaynat/resources/views/dashboard/product/allProduct.blade.php ENDPATH**/ ?>