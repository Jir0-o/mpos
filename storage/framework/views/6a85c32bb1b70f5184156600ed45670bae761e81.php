                    ...
                    <div class="col-md-6 offset-md-2" style="margin-top: 45px; ">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <form action="<?php echo e(route('backoffice.create-new-arraival')); ?>" method="post" autocomplete="off">
...
unset($__errorArgs, $__bag); ?></span>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <a class="btn btn-primary mt-2 float-right" class="text-light" href="<?php echo e(URL::previous()); ?>">Back</a>
                                  </div>
                                  <br>
                              </form>     
                            </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlioxoq/public_html/backofficel/resources/views/dashboard/web/addNewArraival.blade.php ENDPATH**/ ?>