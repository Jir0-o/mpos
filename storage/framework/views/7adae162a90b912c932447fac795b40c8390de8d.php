...
<script>
        $(document).ready(function() {
            ...
            function getdata() {
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('backoffice.fetch-expense')); ?>",
                    dataType: "json",
            ...
            $(document).on('click', '#add_expense', function(event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('backoffice.expense')); ?>",
                    data: data,
                    dataType: "json",
                    success: function(response) {
                        if (response.status == 400) {
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/mpos/resources/views/purchase/expense.blade.php ENDPATH**/ ?>