                            ...
                            <div class="card-body px-3 py-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="color-card">
                                        ...
                                        <br> {{ $all_sell->sum('final_total_amount') }}<span class="h5">.00</span>
                                        </h2>
                                    </div>
                                ...
                                <hr>
                                <a class="btn text-light float-right" href="{{ route('backoffice.all_sales_report') }}">
                                    view report
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="color-card">
                                        ...
                                        <h2 class="text-white">Tk. {{ $all_sell->sum('net_profit') }}<span class="h5">.00</span>
                                        </h2>
                                    </div>
