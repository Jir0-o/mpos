...
<body>
    ...
    <div id="print" xmlns:margin-top="http://www.w3.org/1999/xhtml">
        ...
        <div style="text-align: center;">
            <img height="100px" src="<?php echo e(asset('backend/kaynat.jpeg')); ?>" alt="Restaurant Image">
        </div>
            ...
            <?php $__currentLoopData = $CartInformtionForPrint; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td style="padding-left:10px; padding-right:10px;text-align:right">
                        ...
                        <?php else: ?>
                            <?php echo e($item->quantity); ?> X <?php echo e($item->bulk_price); ?>
                    ...
                    <td style="padding-left:10px; padding-right:10px;text-align:right">
                        ...
                        <?php else: ?>
                            <?php echo e($item->bulk_price * $item->quantity); ?>
        ...
        <hr>
        <div style="text-align: center;">* NO CHANGE * NO REFUND * NO RETURN *</div>
        <hr>
...
<?php /**PATH D:\ussbd\POSSIE\resources\views/sales/print/printInvoice.blade.php ENDPATH**/ ?>