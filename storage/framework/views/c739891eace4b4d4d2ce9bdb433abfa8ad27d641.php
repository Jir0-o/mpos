...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="text-center sidebar-brand-wrapper d-flex align-items-center mb-5 mt-3">
        <a class="sidebar-brand brand-logo" href="<?php echo e(route('backoffice.home')); ?>"><img style="height:100px; width:100px;"
                src="<?php echo e(asset('backend/kaynat.jpeg')); ?>" alt="logo" /></a>
        ...
        <?php if($user_data->role_id == 1 || $user_data->role_id == 2): ?>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-product">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="<?php echo e(route('backoffice.all-purchase')); ?>">Purchases</a>
                        </li>
                        <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ri">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="<?php echo e(route('backoffice.about-company')); ?>">About The
                                Company</a>
                        </li>
                    </ul>
                </div>
...
<?php /**PATH /home/nescggna/public_html/kaynat/resources/views/dashboard/pertials/sideNav.blade.php ENDPATH**/ ?>