        ...
        @if ($user_data->role_id == 1 || $user_data->role_id == 2)
                    ...
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link text-dark"
                                href="{{ asset('backoffice/purchase/daily-purchase-report') }}">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link text-dark"
                                href="{{ asset('backoffice/purchase/all-purchase-report') }}">
                ...
                <div class="collapse" id="ui-return">
                    ...
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link text-dark" href="{{ route('backoffice.create-return') }}">Create
                                Return</a>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link text-dark" href="{{ route('backoffice.all-return') }}">All Returned
                                Requests</a>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link text-dark" href="{{ route('backoffice.completed-return') }}">Completed
                                Return</a>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-return">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('backoffice.create-return') }}">Product
                                Return</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark"
                                href="{{ route('backoffice.create-service-return') }}">Service Return</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('backoffice.all-return') }}">Return
                                Requests</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('backoffice.completed-return') }}">Completed
        ...
        <div class="collapse" id="ui-product">
            ...
            <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link text-dark" href="{{ route('backoffice.all-product-cat') }}">Categories</a>
