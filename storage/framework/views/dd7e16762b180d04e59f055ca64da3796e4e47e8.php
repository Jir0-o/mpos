...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        <label for="sc_one_id">Select Sub Category 1</label>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control my-2" name="cost_price"
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-12 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control my-2" name="sales_price"
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/thechef/resources/views/dashboard/product/editProduct.blade.php ENDPATH**/ ?>