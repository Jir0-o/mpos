                    ...
                    <div class="col-md-6 offset-md-2" style="margin-top: 45px; ">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <form action="<?php echo e(route('backoffice.update-supplier')); ?>" method="post">
                                ...
                                <?php echo csrf_field(); ?>
                                  ...
                                  <input name="id" value="<?php echo e($values->supplier_id); ?>" type="hidden">
                                  <div class="form-group">
                                      <label for="supplier_name">Supplier Name</label>
                                      <input type="text" class="form-control my-2" name="supplier_name" placeholder="Enter Supplier Name" value="<?php echo e($values->supplier_name); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="supplier_address" placeholder="Enter Supplier Address" value="<?php echo e($values->supplier_address); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="supplier_contact_person" placeholder="Supplier Contact Person" value="<?php echo e($values->supplier_contact_person); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="supplier_contact_no" placeholder="Supplier Contact No" value="<?php echo e($values->supplier_contact_no); ?>">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlioxoq/public_html/backofficel/resources/views/dashboard/supplier/editSupplier.blade.php ENDPATH**/ ?>