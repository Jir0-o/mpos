                              ...
                              <form action="<?php echo e(route('backoffice.create-cat1')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <?php echo csrf_field(); ?>
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="sub_cat1_name" placeholder="Enter Sub Category Name" value="<?php echo e(old('sub_cat1_name')); ?>">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nescggna/public_html/kaynat/resources/views/dashboard/product/subCat1.blade.php ENDPATH**/ ?>