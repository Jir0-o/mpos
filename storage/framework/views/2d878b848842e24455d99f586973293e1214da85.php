                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                      ...
                                                      <select class="form-control my-2" name="product_id" id="get_product_id" required>
                                                 ...
                                                 <div class="form-group">
                                                      ...
                                                      <select class="form-control my-2" name="supplier_id">
                                                          ...
                                                          <?php $__currentLoopData = $Supplier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                           <option value="<?php echo e($values->supplier_id); ?>"><?php echo e($values->supplier_name); ?></option>
                                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                      </select>
                                                 ...
                                                 <div class="form-group">
                                                      ...
                                                      <select class="form-control my-2" name="brand_id">
                                                          ...
                                                          <?php $__currentLoopData = $Brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                           <option value="<?php echo e($values->brand_id); ?>"><?php echo e($values->brand_name); ?></option>
                                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                      </select>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-6">
                                                 <div class="form-group">
                                                      ...
                                                      <input required type="text" class="form-control my-2" name="purchase_price" placeholder="Enter Purchase Price" value="<?php echo e(old('purchase_price')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-6">
                                                 <div class="form-group">
                                                      ...
                                                      <input required type="text" class="form-control my-2" name="sales_price" placeholder="Enter Sales Price" value="<?php echo e(old('sales_price')); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-6">
                                                 <div class="form-group">
                                                      ...
                                                      <input required type="number" class="form-control my-2" name="quantity" placeholder="Enter Quantity" value="<?php echo e(old('quantity')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-6">
                                                 <div class="form-group">
                                                      ...
                                                      <input required type="text" class="form-control" name="supply_no" placeholder="Enter Supply No"/>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-6">
                                                 <div class="form-group">
                                                      ...
                                                      <input required type="number" class="form-control" id="courier_cost" name="courier_cost" placeholder="Enter Courier Cost"/>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-6">
                                                 <div class="form-group">
                                                      <label for="transport_cost">Transport Cost</label>
                                                       <input required type="number" class="form-control" id="transport_cost" name="transport_cost" placeholder="Enter Transport Cost"/>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-6">
                                                 <div class="form-group">
                                                      ...
                                                      <input required type="number" class="form-control" id="bonus_point" name="bonus_point" placeholder="Enter Bonus Point"/>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#get_product_id').on('change', function() {
                ...
                $.ajax({
                  url: 'get-ajax-product/'+product_id,
                  type: "GET",
                  data : {"_token":"<?php echo e(csrf_token()); ?>"},
                  dataType: "json",
                  success:function(data)
                  {
                        $('#set_attr_input').empty();
                        $('#checkbox-ajax-inputs').empty();
                        $('#textarea-ajax-inputs').empty();
                                              ...
                                              { 
                                                    $.each(response, function(ke, val){
                                                        ...
                                                        if(val.attribute_type_name == 'checkbox'){
                                                            ...
                                                            var checkboxhtml="<table class='table'>"
                                                                  checkboxhtml+="<tbody>"
                                                                       checkboxhtml+="<tr>"
                                                                        ...
                                                                        checkboxhtml+="</td>"
                                                                        checkboxhtml+="<td>"
                                                                            checkboxhtml+="<input required class='form-control' type='text' id='"+val.attribute_id+"_name' name='"+val.attribute_id+"[]' placeholder='"+val.attribute_name+" Name'>"
                                                                        checkboxhtml+="</td>"
                                                                        checkboxhtml+="<td>"
                                                            ...
                                                            $('#checkbox-ajax-inputs').append(checkboxhtml);
                                                        }else if(val.attribute_type_name == 'textarea'){
                                                                var textareahtml="<div class='form-group'> <label>"+val.attribute_name+"</label>"
                                                                textareahtml+="<textarea required  name='"+val.attribute_id+"' class='form-control' type='"+val.attribute_type_name+"' rows='4'></textarea>"
                                                                textareahtml+="</div>"
                                                                $('#textarea-ajax-inputs').append(textareahtml);
                                                        }
                                                        else{
                                                            var html="<div class='form-group'> <label class='py-2' for='"+val.attribute_name+"'>"+val.attribute_name+"</label>"
                                                            html+="<input required type='"+val.attribute_type_name+"' name='"+val.attribute_id+"' class='form-control'/>"
                                                            html+="</div>"
                                                            
                                                            $('#set_attr_input').append(html);
                                                        }
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlioxoq/public_html/backofficel/resources/views/dashboard/purchase/addPurchase.blade.php ENDPATH**/ ?>