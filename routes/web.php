...
Route::prefix('backoffice')->name('backoffice.')->group(function () {
    ...
    Route::group(['middleware' => ['AuthCheck']], function () {
        ...
        Route::group(['prefix' => 'purchase'], function () {
            ...
            Route::post('/ajax-store-imei', [PurchaseInvoiceController::class, 'ajaxStoreImei'])->name('ajax-store-imei');

            Route::post('/ajax-del-imei', [PurchaseInvoiceController::class, 'ajaxDelImei'])->name('ajax-del-imei');
